...
parser.add_argument('--size', type=int, default=448, help='size of the data crop (squared assumed)')
...
if opt.transfer == True:
    ...
    netG_B2A.load_state_dict('output/netG_B2A.pth')
    netD_A.load_state_dict('output/netD_A.pth')
    netD_B.load_state_dict('output/netD_B.pth')
